...
public class Tester {
    public static void main(String[] args) {
        ...
        //todo da rifattorizzare rendendo privata la lista di menu
        ristoranteGruppo3.menuRistorante.add(menuCarne);
        ristoranteGruppo3.menuRistorante.add(menuPesce);
        ristoranteGruppo3.menuRistorante.add(menuVegano);
        ristoranteGruppo3.menuRistorante.add(menuVegetariano);
