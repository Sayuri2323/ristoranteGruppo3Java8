...
public class Tester {
    public static void main(String[] args) {
        ...
        menuCarne.addPortata(new PrimoPiatto("Spaghetti alla carbonara", 18, TypeEnum.CARNE,TypePrimoEnum.PASTA));
        menuCarne.addPortata(new PrimoPiatto("Pappardelle al sugo di cinghiale", 16, TypeEnum.CARNE,TypePrimoEnum.PASTA));
        menuCarne.addPortata(new PrimoPiatto("Agnolotti con sugo di brasato", 22, TypeEnum.CARNE,TypePrimoEnum.PASTA));
        menuCarne.addPortata(new PrimoPiatto("Ravioli alla bolognese", 16, TypeEnum.CARNE,TypePrimoEnum.PASTA));
        ...
        menuCarne.addPortata(new Dessert("Zuppa inglese", 10, TypeEnum.CARNE,"Servita subito", TypeCotturaEnum.BOLLITO));
        menuCarne.addPortata(new Dessert("Tiramisu", 7, TypeEnum.CARNE, "Con caffè e savoiardi", TypeCotturaEnum.SEMIFREDDO));
        ...
        menuPesce.addPortata(new PrimoPiatto("Ravioli ripieni ci capesante e crema alla zucca", 23, TypeEnum.PESCE,TypePrimoEnum.PASTA));
        menuPesce.addPortata(new PrimoPiatto("Risotto al gambero rosso", 39, TypeEnum.PESCE,TypePrimoEnum.PASTA));
        ...
        menuVegano.addPortata(new Antipasto("Hummus di edamame alla paprika", 112, TypeEnum.VEGANO,"iurfgkulaerfbiuawergiouy",TypeCotturaEnum.BOLLITO));
        menuVegano.addPortata(new Antipasto("Tapenade di olive vegan", 29, TypeEnum.VEGANO));
        menuVegano.addPortata(new PrimoPiatto("Paccheri ripieni di peperoni", 26, TypeEnum.VEGANO,TypePrimoEnum.PASTA));
        menuVegano.addPortata(new PrimoPiatto("Spacghetti con formaggio di anacardi", 43, TypeEnum.VEGANO,TypePrimoEnum.PASTA));
        ...
        menuVegano.addPortata(new Bevanda("Vino", 99.99, TypeEnum.VEGANO,true,"vino pregiato del 34 a.c."));
        ...
        menuVegetariano.addPortata(new PrimoPiatto("Pizzoccheri alla valtellinese", 45, TypeEnum.VEGETARIANO,TypePrimoEnum.PASTA));
        menuVegetariano.addPortata(new PrimoPiatto("Spaghetti cacio e pepe", 19, TypeEnum.VEGETARIANO,TypePrimoEnum.PASTA));
