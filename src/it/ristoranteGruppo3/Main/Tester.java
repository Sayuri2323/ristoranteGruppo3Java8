...
public class Tester {
    public static void main(String[] args) {
        ...
        menuCarne.addPortata(new PrimoPiatto("Spaghetti alla carbonara", 18, TypeEnum.CARNE, TypePrimoEnum.PASTA,"con Guanciale,tuorli e pecorino romano"));
        ...
        menuCarne.addPortata(new PrimoPiatto("Risotto zafferano e salsiccia", 18, TypeEnum.CARNE,TypePrimoEnum.RISO));
        ...
        menuPesce.addPortata(new PrimoPiatto("Risotto al gambero rosso", 39, TypeEnum.PESCE,TypePrimoEnum.RISO));
