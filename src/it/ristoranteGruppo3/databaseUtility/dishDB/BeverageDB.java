...
public class BeverageDB implements ISqlTable {

    private final String tableName = "beverage";

    @Override
    public void createTable(Connection connection) throws SQLException {
        try (Statement createTable = connection.createStatement();) {
            createTable.execute("CREATE TABLE IF NOT EXISTS " + tableName + "(\n" +
                    "id_beverage INT NOT NULL AUTO_INCREMENT,\n" +
                    ...
                    "dishType VARCHAR (16) NOT NULL DEFAULT('Beverage')," +
                    "id_menu INT NOT NULL," +
                    "PRIMARY KEY (id_beverage, id_menu)," +
                    "FOREIGN KEY (id_menu)" +
